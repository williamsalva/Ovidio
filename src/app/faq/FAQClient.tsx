  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
      ...
      <div className="text-center space-y-4">
        <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-accent/10 dark:bg-rose-950/40 text-4xl select-none animate-float">
          ❓
        </div>
      ...
      <div className="relative max-w-lg mx-auto">
        <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-lg select-none">
          🔍
        </div>
        <input
          type="text"
      ...
      <div className="space-y-4">
        {filteredFaqs.length > 0 ? (
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {isOpen ? (
                    <span className="text-xs text-accent shrink-0 ml-4 select-none">▲</span>
                  ) : (
                    <span className="text-xs text-muted shrink-0 ml-4 select-none">▼</span>
                  )}
                </button>
          ...
          <div className="text-center py-10 glass-panel rounded-2xl border border-card-border">
            <div className="text-4xl mx-auto mb-3 select-none">ℹ️</div>
      ...
      <section className="glass-panel p-8 rounded-3xl border border-card-border bg-gradient-to-br from-card-bg to-slate-100/10 dark:from-card-bg dark:to-slate-900/5 text-center space-y-6">
        <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-emerald-100 dark:bg-emerald-950/40 text-4xl select-none animate-wiggle">
          💬
        </div>
        <div className="space-y-2">
          ...
          <p className="text-xs text-muted dark:text-slate-355 max-w-lg mx-auto leading-relaxed">
