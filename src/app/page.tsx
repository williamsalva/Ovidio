...
import { Heart, Award, GraduationCap, Building2, MapPin, Phone, Send, Check, ArrowRight, Activity, Sparkles, Video } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
              <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-accent/10 text-accent text-xs font-semibold uppercase tracking-wider dark:bg-rose-950/35 dark:text-rose-400">
            ...
            <div className="lg:col-span-5 relative flex flex-col items-center justify-center">
              <div className="relative w-full max-w-md h-72 rounded-3xl overflow-hidden glass-panel flex flex-col items-center justify-center p-6 shadow-2xl border border-card-border bg-gradient-to-br from-card-bg to-slate-100/30 dark:from-card-bg dark:to-slate-900/10">
                ...
                <div className="flex items-center space-x-4 mt-6 z-10">
                  <div className="flex items-center justify-center w-12 h-12 rounded-full bg-accent/10 dark:bg-rose-950/40 text-accent animate-heartbeat">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="text-muted dark:text-slate-300 space-y-4 leading-relaxed">
              <p>
                Soy el <strong>Dr. Ovidio Cortázar</strong>, subespecialista en el diagnóstico y tratamiento de arritmias y alteraciones del sistema eléctrico del corazón en lactantes, niños y adolescentes.
              </p>
              <p>
      ...
      <section className="bg-slate-100/60 dark:bg-slate-900/30 py-16 border-y border-slate-200/50 dark:border-slate-800/40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            {/* Certifications Card */}
            <div className="glass-panel p-8 rounded-3xl border border-card-border flex flex-col space-y-6">
              ...
              <ul className="space-y-4 flex-1">
                {certifications.map((cert, index) => (
                  <li key={index} className="flex items-start space-x-3 border-b border-card-border/60 pb-3 last:border-b-0 last:pb-0">
                    <Check className="w-4.5 h-4.5 text-accent mt-0.5" />
                    <div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {locations.map((loc, index) => (
            <div key={index} className="glass-panel p-8 rounded-3xl border border-card-border flex flex-col justify-between hover:shadow-xl transition-shadow duration-300">
              <div className="space-y-4">
                <div className="text-accent font-bold text-sm tracking-wider border-b border-card-border/60 pb-3 uppercase">
                  {loc.name}
                </div>
                <p className="text-xs text-muted dark:text-slate-300 leading-relaxed min-h-[50px]">
                  {loc.address}
                </p>
